Rails.application.routes.draw do
  ...
  get 'policy_plans/:policy_plan_id/game_questions/:game_question_id/select_answer_gamebook/:game_answer_id/', to: 'game_questions#select_answer_gamebook', as: :select_answer_gamebook
